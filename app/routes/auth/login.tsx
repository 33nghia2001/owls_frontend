        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-950">
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-400 transition cursor-not-allowed opacity-60 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-500"
            >
            ...
            >
              ...
              Đăng nhập với Facebook (Sắp ra mắt)
            </button>
          </div>
